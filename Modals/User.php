...
class User
{
  ...
  public function insert_user($data)
  {
        ...
        //Check if username exists
          ...
          if($fetch){
            return header('Location:?error_message=Cette utilisateur deja exist!');
          }else{
            //Query
            ...
            if($new_user){
                return header("Location:users.php?insert_success");
            }else{
                return header('Location:?insert_error_message');
            }
          }
  ...
  public function edit_user($id)
  {
      ...
      if($user){
        ...
        header("Location:?error_messsage=Cette utilisateur n'exist pas!");
      }
  }
  ...
  public function update_user($id,$data)
  {
    ...
    $update_user = $this->db->update($query,[
        $this->username,$this->user_pass,$this->user_privileges,$id
    ]);

    if($update_user) {
        return header("Location:users.php?update_success");
    }else {
  ...
  public function delete_user($id)
  {
    ...
    if($delete_user)
    {
        header("Locatioin:users.php?delete_success");
    }else{
        header("Location:?delete_error");
    }
  }
