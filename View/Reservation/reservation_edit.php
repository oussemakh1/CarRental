                          ...
                          <div class="row mt-3">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="lieu_delivrance"  class="form-control">
                                    <option value="<?php echo $reservation_data['lieu_delivrance']; ?>"><?php echo $reservation_data['lieu_delivrance']; ?></option>
                                                                      ...
                                                                      <div class="row mt-3">
                                                                          ...
                                                                          <div class="form-group col-md-2 ">
                                                                              ...
                                                                              <select name ="assurance" class="form-control" id="input-select">
                                                                                  <option value="<?php echo $reservation_data['assurance']; ?>"><?php echo $reservation_data['assurance']; ?></option>
                                                                             ...
                                                                             <div class="form-group col-md-2">
                                                                                 ...
                                                                                 <input name="heure_depart" type="time" value="<?php echo $reservation_data['heure_depart']; ?>" class="form-control currency-inputmask" id="currency-mask"  >
                                                                                ...
                                                                                <div class="form-group col-md-2">
                                                                                   ...
                                                                                   <div class="form-group col-md-2">
                                                                                       ...
                                                                                       <input name="heure_retour" value="<?php echo $reservation_data['heure_retour']; ?>" type="time" class="form-control currency-inputmask" id="currency-mask" >
