<?php
  ...
  include '../../paginations/PaginationVehicule.php';
                                              ...
                                              <tbody>
                                                ...
                                                <?php
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td><?php echo $car['heure_retour']; ?>
                                                        <td>
                                                          <a href="../Locations/location_info.php?location_id=<?php echo $car['id'];?>">
                                                ...
                                                <?php foreach($car_reservedHistory as $car): ?>
                                                  <tr>
                                                    ...
                                                    <td><?php echo $car['heure_retour']; ?></td>
                                                      <td>
                                                          <a href="../Reservation/reservation_info.php?reservation_id=<?php echo $car['id'];?>">
                                                              <i class="fas fa-address-book"></i>
