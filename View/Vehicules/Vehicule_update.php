                          ...
                          <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name ="fournisseur" class="form-control" id="input-select">
                                   <?php if(!empty($car_data['fournisseur'])) { ?>
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="tva"  class="form-control">
                                    <option value="<?php echo $car_data['tva']; ?>" selected="selected"><?php echo $car_data['tva']; ?>%</option>
                                ...
                                <input name="prix_achat_ttc" value="<?php echo $car_data['prix_achat_ttc']; ?>" type="number" class="form-control" placeholder="prix d'achat ttc..." hidden>
                                                    ...
                                                    <div class="row mt-3">
                                                      ...
                                                      <div class="form-group col-md-3">
                                                          ...
                                                          <select name="type_vehicule" class="form-control" id="input-select">
                                                            <option value="<?php echo $car_data['type_vehicule'];?>"><?php echo $car_data['type_vehicule'];?></option>
                                                      ...
                                                      <div class="form-group col-md-3">
                                                          ...
                                                          <input name="color" value="<?php echo $car_data['color']; ?>" type="text" id="hue-demo" class="form-control demo" data-control="hue">
                                                      </div>
                                                    ...
                                                    <div class="row mt-3">
                                                      ...
                                                      <div class="form-group col-md-3">
                                                          ...
                                                          <input name="n_serie" value="<?php echo $car_data['n_serie']; ?>"  type="text" class="form-control currency-inputmask" id="currency-mask" placeholder="N°serie..." >
                                                      </div>
                                                      <div class="form-group col-md-3">
                                                          <label>N°facture
                                                          </label>
