...
if(!$fetch){
  if(isset($_POST['insert_CompanyInfo'])){
      ...
      $query="INSERT INTO company_info(id,nom_societe,email_societe,telephone,gsm,fax,localisation_ville,localisation_route,country,currency) VALUES(?,?,?,?,?,?,?,?,?,?)";
        $fetch = $db->insert($query,[
          $id,$nom_societe,$email_societe,$telephone,$gsm,$fax,$localisation_ville,$localisation_route,$country,$currency
      ]);
